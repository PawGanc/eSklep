...
import com.moviestore.service.impl.UserSecurityService;
import com.moviestore.utility.MailConstructor;
...
public class HomeController {
	...
	public String newUser(
			Locale locale, @RequestParam("token") String token, Model model) {
